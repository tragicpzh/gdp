...
public class StudentLoginSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Authentication authentication) throws IOException, ServletException {
        ...
        UserInfo userInfo = new UserInfo(student.getStudentId(),student.getName(),student.getPhoneNumber(),student.getEmail(),student.getHeadPortrait(),student.getCreateTime());
