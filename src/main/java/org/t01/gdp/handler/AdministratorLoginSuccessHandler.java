...
public class AdministratorLoginSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Authentication authentication) throws IOException, ServletException {
        ...
        UserInfo userInfo = new UserInfo(administrator.getAdminId(),administrator.getName(),administrator.getPhoneNumber(),administrator.getEmail(),administrator.getHeadPortrait(),administrator.getCreateTime());
