...
//    public Map<String, String> getAccountInfoByRoleId(String role_id) {
//        Map<String, String> infos = new HashMap<>();
//        String role = userMapper.selectByPrimaryKey(role_id).getRole();
//        switch (role) {
//            case "TEA":
//                TeacherExample teacherExample = new TeacherExample();
//                teacherExample.createCriteria().andTeacherIdEqualTo(role_id);
...
//                break;
//            case "ADM":
//                Administrator teacherExample = new TeacherExample();
...
//            StudentExample studentExample = new StudentExample();
//            studentExample.createCriteria().andStudentIdEqualTo(id);
//            resultFlag = studentMapper.deleteByExample(studentExample) == 1;
//        }
//
//        if (resultFlag) {
