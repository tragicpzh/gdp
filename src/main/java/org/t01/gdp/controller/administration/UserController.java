...
//        return null;//userService.addUser(name, phoneNumber, email, role, otherInfo);
//    }
//
//    @ResponseBody
...
//                             @RequestParam(name = "role") String role,
//                             @RequestParam(name = "otherInfo") String otherInfo) {
//        return null;//userService.updateUser(id, name, phoneNumber, email, role, otherInfo);
//    }
//
//    @ResponseBody
...
//                }
//            }
//            String message = null;//userService.addUser(name, phoneNumber, email, role, otherInfo);
...
//        return null;//userService.getUserByRole(role);
//    }
//
//    @ResponseBody
...
//                                  @RequestParam(name = "role") String role) {
//        return false;//userService.deleteUserById(id, role);
//    }
//
//    @ResponseBody
...
//        for (String id : ids) {
//            if (false) {//userService.deleteUserById(id, role)
//                count--;
//            }
//        }
